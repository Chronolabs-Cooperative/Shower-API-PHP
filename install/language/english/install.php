...
define('API_CONFIG_AUDIO', 'Configure Audio for Labs Safety Shower');
define('API_CONFIG_BACKGROUND', 'Configure background\'s for Labs Safety Shower');
// License
...
define('PATHS_AUDIO', 'Configure Shower Audio');
define('PATHS_AUDIO_TITLE', 'Configure Shower Audio');
define('PATHS_BACKGROUND', 'Configure Shower Background');
define('PATHS_BACKGROUND_TITLE', 'Configure Shower Background');
