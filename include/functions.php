...
if (!function_exists("getAudioListAsArray")) {
	function getAudioListAsArray($dirname, $prefix = '')
	{
		$formats = cleanWhitespaces(file(__DIR__ . DIRECTORY_SEPARATOR . 'data' . DIRECTORY_SEPARATOR . 'audio-formats.diz'));
		$filelist = array();
...
if (!function_exists("getImagesListAsArray")) {
    function getImagesListAsArray($dirname, $prefix = '')
    {
        $formats = cleanWhitespaces(file(__DIR__ . DIRECTORY_SEPARATOR . 'data' . DIRECTORY_SEPARATOR . 'images-formats.diz'));
        $filelist = array();
